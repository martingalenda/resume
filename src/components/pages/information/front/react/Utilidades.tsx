...
const UtilidadesReact = () => {

    return (
        <Information>

            <TopicContainer topic="Utilidades">
                <h4>React hook form = <a href="https://react-hook-form.com/" target="_blank">Link</a> Librería para desarrollar formularios.</h4><br/> 
                <h4>React MUI = <a href="https://mui.com/" target="_blank">Link</a>  Librería de componentes personalizados.</h4><br/>
                <h4>React Slick = <a href="https://www.npmjs.com/package/react-slick/" target="_blank">Link</a> Libreria de sliders personalizados.</h4> <br/>
...
export default UtilidadesReact